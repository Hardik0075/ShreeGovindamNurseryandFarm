...
class GovindamChatbot {
    constructor() {
        ...
        this.plantData = {
            ...
            Chikoo: { carbon: 18, category: 'Fruit', care: 'Full sun, well-drained soil, regular watering', benefits: 'Sweet brown fruits, evergreen tree, good for diabetes management' },
            Sitafal: { carbon: 16, category: 'Fruit', care: 'Full sun, well-drained soil, moderate watering', benefits: 'Custard apple fruits, rich in vitamin C, antioxidant properties' },
            ...
            Arjun: { carbon: 24, category: 'Medicinal', care: 'Full sun, moist soil, slow growing', benefits: 'Heart health benefits, strong timber, sacred tree, bark used in Ayurveda' },
